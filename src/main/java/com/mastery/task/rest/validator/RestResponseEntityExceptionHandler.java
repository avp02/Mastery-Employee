package com.mastery.task.rest.validator;
...
public class RestResponseEntityExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity<Object> mapNEmployeeNotFoundException(EmployeeNotFoundException e) {
        ...
        log.info("Method mapNEmployeeNotFoundException in class {}", getClass().getName());
    ...
    public ResponseEntity<Object> mapDataAccessException(DataAccessException e) {
        ...
        log.info("Method mapDataAccessException in class {}", getClass().getName());
    ...
    public ResponseEntity<Object> handleIllegalArgumentException(
        ...
        log.info("Method handleIllegalArgumentException in class {}", getClass().getName());

        if (e.getMessage().contains("No enum constant com.mastery.task.model.Gender.")) {
            ApiError apiError = new ApiError(
                    HttpStatus.BAD_REQUEST,
                    "Invalid gender",
    ...
    public ResponseEntity<Object> handleConstraintViolationException(ConstraintViolationException e) {
        ...
        log.info("Method handleConstraintViolationException in class {}", getClass().getName());
    ...
    protected ResponseEntity<Object> handleMethodArgumentNotValid(
        ...
        log.info("Method handleMethodArgumentNotValid in class {}", getClass().getName());
    ...
    protected ResponseEntity<Object> handleHttpMessageNotReadable(
        ...
        log.info("Method handleHttpMessageNotReadable in class {}", getClass().getName());
    ...
    protected ResponseEntity<Object> handleHttpMediaTypeNotSupported(
        ...
        log.info("Method handleHttpMediaTypeNotSupported in class {}", getClass().getName());
    ...
    protected ResponseEntity<Object> handleHttpMediaTypeNotAcceptable(
        ...
        log.info("Method handleHttpMediaTypeNotAcceptable in class {}", getClass().getName());
    ...
    protected ResponseEntity<Object> handleHttpRequestMethodNotSupported(
        ...
        log.info("Method handleHttpRequestMethodNotSupported in class {}", getClass().getName());
    ...
    protected ResponseEntity<Object> handleNoHandlerFoundException(
        ...
        log.info("Method handleNoHandlerFoundException in class {}", getClass().getName());
    ...
    public ResponseEntity<Object> handleAll(
        ...
        log.info("Method handleAll in class {}", getClass().getName());
